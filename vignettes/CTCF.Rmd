...
`r BiocStyle::Biocpkg('BiocCheck')` defines an AnnotationHub resource representing genomic coordinates 
...
Please note that the `r BiocStyle::Biocpkg('BiocCheck')` was only made possible thanks to many other R and 
